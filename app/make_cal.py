	...
	try:
		...
		html_framework(
			Tag('p')(
				...
				Tag('a', {'href': 'https://github.com/kdemerath/HabitRPG-Calendar', 'target': '_blank'})('GitHub page'),
				' and talk to Klaus about it. Alternatively, send me a message on Habitica (@Klaus Demerath).',
				Tag('br'),
				Tag('br'),
				'Error occurred: ',
				str(e),
